...
export default function WhatWeDoCard({ data }: Props) {
    ...
    return (
        <div className='grid gap-1 lg:gap-4 grid-rows-[auto_auto_1fr] cursor-pointer group' onClick={getEstimate}
        ...
        >
            ...
            <div className='relative row-start-1 bg-pink-50 rounded-md'>
                <div className='aspect-[350/200] lg:aspect-[366/400] rounded-md'>
                    <Image width="549" alt="" height="690" src={data.imageSrc} className='invisible h-full w-auto object-cover rounded-[inherit]' />
                    <Image width="549" alt="" height="690" src={data.imageSrc} className='absolute top-0 left-0 h-full w-auto object-cover rounded-[inherit]' />
                </div>
                <div className={"group-hover:h-8 group-hover:opacity-100 h-0 rounded-b-lg opacity-0 pointer-fine:hidden absolute bottom-0 transition-all bg-overlay-from w-full text-white"}>Get Estimate?</div>
