...
export default function NewPage({}: Props) {
  const Item = () => (
    <div className="relative text-center text-xl lg:text-11xl h-full">
      <Image
        width={30}
        height={30}
      ...
      <div className="flex flex-col items-center justify-center h-full">
        <article
          className="p-8 md:p-20 flex flex-col-reverse gap-5 md:gap-10 items-center"
          aria-label="Review by Caitlyn Mathews from Company Name"
        >
