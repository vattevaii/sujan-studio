            ...
            {[
                {
                    ...
                    images: ["http://placekitten.com/200/300", "http://placekitten.com/200/300", "http://placekitten.com/200/300", "http://placekitten.com/200/300", "http://placekitten.com/200/300", "http://placekitten.com/200/300",]
                },
                {
...
export const getStaticProps: GetStaticProps<{ locations: LocationItem[] }> = () => {
    return {
        props: {
            locations: [
                {
